...
{
    public class DGVToggleButtonMetroRender : DGVToggleButtonRenderBase
    {

        #region Constructor

        public DGVToggleButtonMetroRender()
        {
        ...
        {
            Rectangle adjustedLeftRect = new Rectangle(leftRectangle.X + 2,leftRectangle.Y+ 2, leftRectangle.Width - 2, leftRectangle.Height - 4);
            ...
            if (adjustedLeftRect.Width > 0)
            {
                ...
                if (ToggleSwitch.Enabled==false && ToggleSwitch.GrayWhenDisabled)
                ...
                if (!string.IsNullOrEmpty(ToggleSwitch.OnText))
                {
                    ...
                    if (!ToggleSwitch.ReadOnly && ToggleSwitch.GrayWhenDisabled)
        ...
        {
            Rectangle adjustedRightRect = new Rectangle(rightRectangle.X, rightRectangle.Y+2, rightRectangle.Width - 2, rightRectangle.Height - 4);
        ...
        {
            return (int)((double)ControlRect.Height / 3 * 2);
        }
        ...
        {
            var pCloned = new DGVToggleButtonMetroRender();
            pCloned.BackColor               =this.BackColor;            
            pCloned.LeftSideColor           =this.LeftSideColor ;       
            pCloned.LeftSideColorHovered    =this.LeftSideColorHovered ;
            pCloned.LeftSideColorPressed    =this.LeftSideColorPressed; 
            pCloned.RightSideColor          =this.RightSideColor;       
            pCloned.RightSideColorHovered   =this.RightSideColorHovered;
            pCloned.RightSideColorPressed   =this.RightSideColorPressed;
            pCloned.BorderColor             =this.BorderColor;          
            pCloned.ButtonColor             =this.ButtonColor ;         
            pCloned.ButtonColorHovered      =this.ButtonColorHovered ;  
            pCloned.ButtonColorPressed      =this.ButtonColorPressed;                   
            return pCloned;
        }*/
