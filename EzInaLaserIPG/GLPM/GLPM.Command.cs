...
namespace EzIna.Laser.IPG
{
		public enum GLPM_CMD
		{
				...
				/// <summary>
				/// Sent: RCT
				/// <para>Response:RCT: 28.9 </para> 
				/// </summary>
				[PacketAttribute("RCT", "", "", true, true, true, true, enumPacketMode.GettingOnly)]
				CASE_TEMP,
				/// <summary>
				/// Sent: RHT
				/// <para>Response:RHT: 28.9 </para> 
				/// </summary>
				...
				/// </summary>
				[PacketAttribute("RBR", "", "", true, true, true, true, enumPacketMode.GettingOnly)]
				BACK_REFLECTION,
				...
				/// </summary>
				//[PacketAttribute("RETF", "", "", true, true, true, true, enumPacketMode.GettingOnly)]
		...
		static partial class EnumHelper
		{
				...
				/// <returns></returns>
				public static PacketAttribute GetPacketAttrFrom(this GLPM_CMD a_Value)
				{
						return a_Value.GetType().GetMember(a_Value.ToString())
													 .First()
													 .GetCustomAttribute<PacketAttribute>();
				}
				public static string GetPacketAttrstrCMD(this GLPM_CMD a_Value)
				{
						return a_Value.GetType().GetMember(a_Value.ToString())
													 .First()
				...
				public static string GetPacketAttrstrSetMark(this GLPM_CMD a_Value)
				{
						return a_Value.GetType().GetMember(a_Value.ToString())
													 .First()
				...
				public static string GetPacketAttrstrGettingMark(this GLPM_CMD a_Value)
				{
						return a_Value.GetType().GetMember(a_Value.ToString())
													 .First()
