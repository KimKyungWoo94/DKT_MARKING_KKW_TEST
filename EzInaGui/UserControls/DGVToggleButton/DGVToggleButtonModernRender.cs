...
{
    public class DGVToggleButtonModernRender:DGVToggleButtonRenderBase ,IDisposable
    {
        #region Constructor

        private GraphicsPath _innerControlPath = null;

        public DGVToggleButtonModernRender()
        {
        ...
        {
            float buttonWidth = 1.41f * ControlRect.Height;
        ...
        {
            var pCloned=new DGVToggleButtonModernRender();
            ...
            pCloned.ArrowNormalColor            = this.ArrowNormalColor;
            ...
            pCloned.ArrowHoverColor             = this.ArrowHoverColor;
            ...
            pCloned.ArrowPressedColor           = this.ArrowPressedColor;
