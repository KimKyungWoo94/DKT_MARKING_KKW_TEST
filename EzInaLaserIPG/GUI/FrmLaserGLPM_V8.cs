...
namespace EzIna.Laser.IPG.GUI
{
    ...
    /// 
    /// </summary>
    public partial class FrmLaserGLPM_V8 : Form
    {
        ...
        public FrmLaserGLPM_V8()
        {
            ...
            AddLaserParameter(false ,"0.00 ℃"      ,"Monitor"          ,"Set Point Crystal Temp"   ,"");
            AddLaserParameter(false ,"0.00 ℃"      ,"Monitor"          ,"Actual Crystal Temp"      ,"");
        ...
        public void InitForm(Laser.LaserInterface a_Item)
        {
            if (a_Item == null)
                return;
            if (a_Item.DeviceType == typeof(Laser.IPG.GLPM_V8))
            {
                pItem = a_Item  as Laser.IPG.GLPM_V8;
            }
        }
        /// <summary>
        /// 
        ...
        public void UpdateDisplay()
        {
            if(pItem!=null)
            {
                ...
                if(pItem.IsConnected)
                {
                    ...
                    lb_EmissionTime.Text =$"{pItem.iEmssionTime} Minutes";
                    ...
                    DGV_LaserParam["Value",(int)DGV_ROW_IDX.SET_POINT_CRYSTAL_TEMP].Value=pItem.fSetPointCrystalTemp;
                    DGV_LaserParam["Value",(int)DGV_ROW_IDX.ACTUAL_CRYSTAL_TEMP].Value=pItem.fSetPointCrystalTemp;
            ...
            if(DGV_LaserParam.Columns["Value"].Index ==e.ColumnIndex)
            {
                ...
                switch (idx)
                {
                    ...
                    case DGV_ROW_IDX.HEAD_TEMP:
                        break;
                    case DGV_ROW_IDX.SET_POINT_CRYSTAL_TEMP:
                        break;
                    case DGV_ROW_IDX.ACTUAL_CRYSTAL_TEMP:
                        break;
