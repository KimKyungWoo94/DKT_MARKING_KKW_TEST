...
public enum AXT_FUNC_RESULT:uint
{
    ...
    AXT_RT_MOTION_READ_ALARUNKNOWN            = 4220,     // 알람코드가 알수없는 코드일 때
...
public class CAXHS
{
    ...
    public readonly static uint WUSER                     = 0x0400;
    public readonly static uint WM_AXL_INTERRUPT            = (WUSER + 1001);
