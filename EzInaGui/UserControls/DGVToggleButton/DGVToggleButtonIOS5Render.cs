...
{
    public class DGVToggleButtonIOS5Render: DGVToggleButtonRenderBase
    {
        #region Constructor

        public DGVToggleButtonIOS5Render()
        {
        ...
        public override void RenderLeftToggleField(Graphics g, Rectangle leftRectangle, int totalToggleFieldWidth)
        {
            ...
            Rectangle controlRectangle = new Rectangle(ControlRect.X, ControlRect.Y, ControlRect.Width, ControlRect.Height);
            ...
            {
                upperGradientPath.AddArc(upperGradientRectangle.X, upperGradientRectangle.Y, ControlRect.Height, ControlRect.Height, 135, 135);
            ...
            {
                lowerGradientPath.AddArc(lowerGradientRectangle.X+1, lowerGradientRectangle.Y, (int)(0.75 * (ControlRect.Height - 1)), ControlRect.Height - 1, 215, 45); //Arc from side to top
                ...
                lowerGradientPath.AddArc(lowerGradientRectangle.X+1,lowerGradientRectangle.Y+ 1, ControlRect.Height - 1, ControlRect.Height - 1, 90, 70); //Arc from side to bottom
            ...
            controlRectangle = new Rectangle(ControlRect.X, ControlRect.Y, ControlRect.Width, ControlRect.Height);
            ...
            {
                RectangleF fullRectangle = new RectangleF(leftRectangle.X + 2 - (totalToggleFieldWidth - leftRectangle.Width),leftRectangle.Y+ 2, totalToggleFieldWidth - 2, ControlRect.Height - 4);
                Trace.WriteLine(fullRectangle);
        ...
        public override void RenderRightToggleField(Graphics g, Rectangle rightRectangle, int totalToggleFieldWidth)
        {
            ...
            {
                upperGradientPath.AddLine(upperGradientRectangle.X, upperGradientRectangle.Y, upperGradientRectangle.X + upperGradientRectangle.Width, upperGradientRectangle.Y);
                upperGradientPath.AddArc(upperGradientRectangle.X + upperGradientRectangle.Width - ControlRect.Height + 1, upperGradientRectangle.Y - 1, ControlRect.Height, ControlRect.Height, 270, 115);
            ...
            using (GraphicsPath lowerGradientPath = new GraphicsPath())
            {
                ...
                lowerGradientPath.AddArc(lowerGradientRectangle.X + lowerGradientRectangle.Width - (int)(0.75 * (ControlRect.Height - 1)), lowerGradientRectangle.Y, (int)(0.75 * (ControlRect.Height - 1)), ControlRect.Height - 1, 270, 45);  //Arc from top to side
                lowerGradientPath.AddArc(lowerGradientRectangle.X+ControlRect.Width - ControlRect.Height, lowerGradientRectangle.Y, ControlRect.Height, ControlRect.Height, 20, 70); //Arc from side to bottom
            ...
            {
                RectangleF fullRectangle = new RectangleF(rightRectangle.X, rightRectangle.Y+2, totalToggleFieldWidth - 2, ControlRect.Height - 4);
        ...
        {
            if (ToggleSwitch.IsButtonOnLeftSide(ToggleSwitch.ButtonValue))
                buttonRectangle.X += 1;
            else if (ToggleSwitch.IsButtonOnRightSide(ToggleSwitch.ButtonValue))
                buttonRectangle.X -= 1;
