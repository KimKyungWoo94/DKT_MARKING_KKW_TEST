...
namespace EzInaVision
{
	public class IniFile
	{
        ...
        public void Write(string section, string key, float fValue)
        {
            WritePrivateProfileString(section, key, fValue.ToString("F5"), FileName);
        }
		...
		{
			return (uint)Convert.ToInt32(Read(section, key, defaultValue.ToString()));
		}
        ...
        {
            return Convert.ToSingle(Read(section, key, defaultValue.ToString()));
        }
